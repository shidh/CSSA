...
public class Post extends Model {
	...
	public Post(String title, Date postingDate, String postContent,
			PostContent content, User sender, String postcreatDate) {
		super();
		this.title = title;
	...
	public String getpostcreatDate() {
		return postcreatDate;
	}
	public void setpostcreatDate(String postcreatDate) {
		this.postcreatDate = postcreatDate;
	}
